...
{
       0,    38,    38,    40,    61,    80,   127,   133,   141,   157,
     165,   170,   205,   234,   236,   238,   240,   243,   248,   255,
     258,   259,   260,   261,   263,   264,   266,   278,   280,   306,
     319,   320,   322,   324,   348,   350,   352,   355,   357,   375,
     376,   378,   379,   572,   573,   574,   593,   602,   613,   619,
     620,   622,   654,   689,   695,   709,   717,   721,   726,   736,
     745,   752,   773,   794,   813,   832,   852,   863,   869,   870,
     872,   873,   875,   880,   886,   889,   899,   911,   917,   918,
     920,   932,   937,   948,   950,   955,   964,   966,   993,   996,
    1062,  1065,  1079,  1107,  1110,  1139,  1142,  1188,  1207,  1217,
    1262,  1264,  1291,  1293,  1296,  1298,  1300,  1302,  1304,  1306,
    1309,  1311,  1314,  1316,  1319,  1348,  1362,  1375,  1376,  1378,
    1389,  1390,  1400
};
#endif
...
#line 84 "ada.y" /* yacc.c:1646  */
    {
                          ...
                          printDFS(arr[i].Root);
                          Pop();
                          //fprintf(output, "AAAAAAAAAAAAAAAAAAAAAA%d\n", GlobalTrack.Instruction);
                          ...
                          // TODO HIGHLY QUESTIONABLEEEEEEEEEEEEEEEEEEEEEEEEE
                          outcome -> next = (yyvsp[-7].node_p);
                          //////////////////////////////////////////////////////
 ///////////////////////////////////////////////////////////////////////////////////
                          node_t * current = (yyvsp[-7].node_p);
                          while (current != NULL) {
                          //fprintf(output, "kkkkkkkkkkkkkk %s \n", current-> var);
                          //fprintf(output, "jajaklhasdhasdhadsjh        %s \n", current-> mode);
...
/////////////////////////////////////////////////////////////////////////////////////////////////
                          /*if (GlobalTrack.raise_list != 0) {
                              AddPatchList(GlobalTrack.raise_list, GlobalTrack.Instruction);
                          }*/
                          //fprintf(output, "kkkkkkkkkkkkkkkkkkkkkkkkk %d\n", GlobalTrack.Instruction);
                          fprintf(output, "%d     r%d := contents b, 1\n", GlobalTrack.Instruction++, GlobalTrack.register_Num);
                          fprintf(output, "%d     b := contents b, 3\n", GlobalTrack.Instruction++);
                          fprintf(output, "%d     pc := r%d\n", GlobalTrack.Instruction++, GlobalTrack.register_Num++);
...
#line 1725 "y.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 237 "ada.y" /* yacc.c:1646  */
    {(yyval.var) = "out";}
#line 1731 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 239 "ada.y" /* yacc.c:1646  */
    {(yyval.var) = "in";}
#line 1737 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 241 "ada.y" /* yacc.c:1646  */
    {(yyval.var) = "in";}
#line 1743 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 244 "ada.y" /* yacc.c:1646  */
    {
...
#line 1762 "y.tab.c" /* yacc.c:1646  */
  ...
  case 19:
#line 256 "ada.y" /* yacc.c:1646  */
    {(yyval.var) = (yyvsp[0].var);}
#line 1768 "y.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 258 "ada.y" /* yacc.c:1646  */
...
#line 1780 "y.tab.c" /* yacc.c:1646  */
  ...
  case 22:
#line 260 "ada.y" /* yacc.c:1646  */
    {(yyval.integer) = currentOffset();}
#line 1786 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 261 "ada.y" /* yacc.c:1646  */
    {(yyval.integer) = currentOffset();}
...
#line 1880 "y.tab.c" /* yacc.c:1646  */
  ...
  case 35:
#line 351 "ada.y" /* yacc.c:1646  */
    {(yyval.integer) = 0;}
#line 1886 "y.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 353 "ada.y" /* yacc.c:1646  */
    {(yyval.integer) = (yyvsp[0].integer);}
#line 1892 "y.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 358 "ada.y" /* yacc.c:1646  */
    {
				     LL_node current;
...
#line 380 "ada.y" /* yacc.c:1646  */
    {
			                   ...
			                   //if ($3 -> Value == 0 && $2 == NULL) { //If op_param and op_assign are both empty, it is a procedure call.
				                      ...
				                      GlobalTrack.register_Num++;
                                                      ...
                                                      //printf("YAAAAAA %d\n", $2 ->record_List->Offset);
                                                     //printf("YeeeeeAAAAAA %d\n", $2 -> next -> record_List -> Offset);
                                                      ...
                                                      while (current != NULL) {
                                                           if (strcmp(current->mode, "in") == 0) {
                                                               //fprintf(output, "eeeeeeeeeeeed %s\n", current->var);
                                                                     fprintf(output, "%d     contents b, %d := r%d\n", GlobalTrack.Instruction++, current->value, currentRW -> record_List -> Reg_Num);
                                                           }
               ...
               //fprintf(output, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
               //struct LL_RW * currentRW = $2;
               //fprintf(output, "sjjsjsjsjs %d\n", currentRW -> record_List -> Reg_Num );
               ...
               //fprintf(output, "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\n");
...
#line 575 "ada.y" /* yacc.c:1646  */
    {
                         ...
                         if (GlobalTrack.in_exception_part == true) {
                          ...
                          fprintf(output, "%d     r1 := %d\n", GlobalTrack.Instruction++, outcome->ival);
                          fprintf(output, "%d     pc := ?\n", GlobalTrack.Instruction);
                          //fprintf(output, "%d     pceeeeeeeeeeeeeeeee := ?\n", GlobalTrack.Instruction);
                          GlobalTrack.raise_list = GlobalTrack.Instruction;
                          GlobalTrack.Instruction++;
                          }
                         }
...
#line 655 "ada.y" /* yacc.c:1646  */
    {
                         if (GlobalTrack.case_or == 1) {
                              ...
                              //AddPatchList(tempnum, GlobalTrack.Instruction+2);
                              struct LLNum_node * temp = (yyvsp[0].headNum);
                              while (temp -> next != NULL) {
                                   GlobalTrack.case_or_counter_checker++;
                                   fprintf(output, "%d     r%d := r%d = r%d\n", GlobalTrack.Instruction++,
                                   GlobalTrack.register_Num, temp -> data, case_register[casecounter]);
                                   case_ornot[GlobalTrack.case_or_counter_checker] = GlobalTrack.Instruction;
                                   //AddPatchList(GlobalTrack.Instruction, GlobalTrack.Instruction+2);
...
#line 696 "ada.y" /* yacc.c:1646  */
    {
                          ...
                          GlobalTrack.case_or = 0;
                          fprintf(output, "%d     r%d := r%d = r%d\n", GlobalTrack.Instruction++, GlobalTrack.register_Num,
                          GlobalTrack.register_Num - 1, case_register[casecounter]);
                          fprintf(output, "%d     pc := ? if not r%d\n", GlobalTrack.Instruction, GlobalTrack.register_Num);
                          AddPatch(GlobalTrack.Instruction);
                          GlobalTrack.register_Num++;
                          GlobalTrack.Instruction++;
...
#line 2494 "y.tab.c" /* yacc.c:1646  */
  ...
  case 74:
#line 887 "ada.y" /* yacc.c:1646  */
    {(yyval.record_p) = (yyvsp[0].record_p);}
#line 2500 "y.tab.c" /* yacc.c:1646  */
    break;

  case 75:
#line 890 "ada.y" /* yacc.c:1646  */
    {
		         struct patch_list * temp = ToPatch_Arr[ToPatchCounter];
		       	 while (temp != NULL) {
                              AddPatchList(temp->location, GlobalTrack.Instruction);
...
#line 2582 "y.tab.c" /* yacc.c:1646  */
  ...
  case 85:
#line 956 "ada.y" /* yacc.c:1646  */
    {
                         PushToPatchStack();
                         //fprintf(output, "PUSHER %d\n", ToPatchCounter);
...
#line 1218 "ada.y" /* yacc.c:1646  */
    {
           ...
           //}
						...
						while (x > 0) {
							fprintf(output, "%d     r%d := contents r%d, 2\n", GlobalTrack.Instruction++,
                                                        GlobalTrack.register_Num, GlobalTrack.register_Num);
							x--;
						}
						record_p -> Offset = outcome -> offset;
						record_p -> Reg_Num = GlobalTrack.register_Num++;
...
#line 2984 "y.tab.c" /* yacc.c:1646  */
  ...
  case 103:
#line 1294 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "or");}
#line 2990 "y.tab.c" /* yacc.c:1646  */
    break;

  case 104:
#line 1297 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "=");}
#line 2996 "y.tab.c" /* yacc.c:1646  */
    break;

  case 105:
#line 1299 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "/=");}
...
#line 3014 "y.tab.c" /* yacc.c:1646  */
  ...
  case 108:
#line 1305 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), ">=");}
#line 3020 "y.tab.c" /* yacc.c:1646  */
    break;

  case 109:
#line 1307 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "<=");}
#line 3026 "y.tab.c" /* yacc.c:1646  */
    break;

  case 110:
#line 1310 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "+");}
#line 3032 "y.tab.c" /* yacc.c:1646  */
    break;

  case 111:
#line 1312 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "-");}
#line 3038 "y.tab.c" /* yacc.c:1646  */
    break;

  case 112:
#line 1315 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "*");}
#line 3044 "y.tab.c" /* yacc.c:1646  */
    break;

  case 113:
#line 1317 "ada.y" /* yacc.c:1646  */
    {strcpy((yyval.var), "/");}
#line 3050 "y.tab.c" /* yacc.c:1646  */
    break;

  case 114:
#line 1320 "ada.y" /* yacc.c:1646  */
    {
                         //GlobalTrack.raise_list = 0;
...
#line 3083 "y.tab.c" /* yacc.c:1646  */
  ...
  case 115:
#line 1349 "ada.y" /* yacc.c:1646  */
    {
                         if (GlobalTrack.instruction_counter == 0 && GlobalTrack.raise_list != 0) {
                                   AddPatchList(GlobalTrack.raise_list, GlobalTrack.Instruction);
                         } else {
                              //TODO NOT TOO SURE IF THIS IS OK....... NEED TO CHECK. 
                              //fprintf(output, "AAAAAAAAAAAAAAAAAAAAAAAAAAA %d\n", GlobalTrack.instruction_counter);
...
#line 1363 "ada.y" /* yacc.c:1646  */
    {
                         ...
                         //AddPatchList(GlobalTrack.exception_jump, GlobalTrack.Instruction);
                         fprintf(output, "%d     pc := r1, ?\n", GlobalTrack.Instruction++);
                         //GlobalTrack.exception_jump = GlobalTrack.Instruction;
                        }
...
#line 1379 "ada.y" /* yacc.c:1646  */
    {
                         ...
                         fprintf(output, "%d     pc := ?\n", GlobalTrack.Instruction);
                         GlobalTrack.raise_list = GlobalTrack.Instruction;
                         //fprintf(output, "RAIIIIIIIIIIIIIIIIIIIISE LIST %d\n", GlobalTrack.raise_list);
                         AddPatch(GlobalTrack.raise_list);
                         GlobalTrack.Instruction++;
                        }
